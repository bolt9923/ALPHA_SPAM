...
async def ping(e):
    if e.sender_id in SUDO_USERS:
        start = datetime.now()
        altron = await e.reply(f"•[𝁘ໍ ꯭ོ𓍢꯭ִ ꯭𝐃꯭𝚲꯭፝֟𝐑꯭𝐊꯭ ꯭𝐒꯭𝗢꯭𝐂𝐈꯭𝙴֟፝𝐭꯭𝐘꯭ 🌙 ❛ ֺ ❜ 💗ˎ♤ ]•")
        end = datetime.now()
        mp = (end - start).microseconds / 1000
        await altron.edit(f"[🍹] 𝁘ໍ ꯭ོ𓍢꯭ִ ꯭𝐃꯭𝚲꯭፝֟𝐑꯭𝐊꯭ ꯭𝐒꯭𝗢꯭𝐂𝐈꯭𝙴֟፝𝐭꯭𝐘꯭ 🌙 ❛ ֺ ❜ 💗ˎ♤ ɪѕ нєʀє\n[🏓] αвє αв тєʀα куα нσgα\n[⚡] кιѕкι ᴄнυ∂αι кαʀиι нαι\n\n➜ `{mp} ms`")
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        await e.reply(f"ʀєвσσт ᴅσиє\n[🍷] 2 мιит ωαιт ᴘℓєαѕє\n[🫧] fιʀ ααʏєɢα тєʀɪ мᴀᴀ ᴄнσᴅиє 𝁘ໍ ꯭ོ𓍢꯭ִ ꯭𝐃꯭𝚲꯭፝֟𝐑꯭𝐊꯭ ꯭𝐒꯭𝗢꯭𝐂𝐈꯭𝙴֟፝𝐭꯭𝐘꯭ 🌙 ❛ ֺ ❜ 💗ˎ♤ ")
        try:
            await X1.disconnect()
        except Exception:
            pass
...
async def addsudo(event):
    if event.sender_id == OWNER_ID:
        ...
        ok = await event.reply(f"»🍃 𝁘ໍ ꯭ོ𓍢꯭ִ ꯭𝐃꯭𝚲꯭፝֟𝐑꯭𝐊꯭ ꯭𝐒꯭𝗢꯭𝐂𝐈꯭𝙴֟፝𝐭꯭𝐘꯭ 🌙 ❛ ֺ ❜ 💗ˎ♤ єк σʀ иєω вєтα αᴅᴅ нσ gуα 🍃")
        target = ""
        ...
        if str(target) in sudousers:
            ...
            if len(sudousers) > 0:
                ...
                newsudo = f"{target}"
            await ok.edit(f"» σує нσує мєʀα ᴄυтє вαᴄнα\n:⧽ `{target}`\n:⧽ `ωєℓᴄσмє тσ 𝁘ໍ ꯭ོ𓍢꯭ִ ꯭𝐃꯭𝚲꯭፝֟𝐑꯭𝐊꯭ ꯭𝐒꯭𝗢꯭𝐂𝐈꯭𝙴֟፝𝐭꯭𝐘꯭ 🌙 ❛ ֺ ❜ 💗ˎ♤ ѕραм`")
