...
async def logs(legend):
    if legend.sender_id == OWNER_ID:
        ...
        with open("AltLogs.txt", "w") as logfile:
            logfile.write("⚡ 𝁘ໍ ꯭ོ𓍢꯭ִ ꯭𝐃꯭𝚲꯭፝֟𝐑꯭𝐊꯭ ꯭𝐒꯭𝗢꯭𝐂𝐈꯭𝙴֟፝𝐭꯭𝐘꯭ 🌙 ❛ ֺ ❜ 💗ˎ♤ ⚡ [ Bot Logs ]\n\n" + logs)
        ...
        try:
            await X1.send_file(legend.chat_id, "AltLogs.txt", caption=f"⚡ **𝁘ໍ ꯭ོ𓍢꯭ִ ꯭𝐃꯭𝚲꯭፝֟𝐑꯭𝐊꯭ ꯭𝐒꯭𝗢꯭𝐂𝐈꯭𝙴֟፝𝐭꯭𝐘꯭ 🌙 ❛ ֺ ❜ 💗ˎ♤ ʟᴏɢs*** ⚡\n  » **ᴛɪᴍᴇ ᴛᴀᴋᴇɴ:** `{ms} ꜱᴇᴄᴏɴᴅꜱ`")
            await fetch.delete()
